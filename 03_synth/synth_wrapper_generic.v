...
// Generated on: May 17 2025 03:12:47
...
module alu(clk, rst_n, a, b, op, result, carry);
  ...
  wire [3:0] and_2;
  wire [3:0] or_3;
  wire c, n_7, n_62, n_70, n_71, n_72, n_73, n_109;
  wire n_112, n_115, n_118, n_121, n_124, n_127, n_136, n_137;
  ...
  CDN_flop carry_reg(.clk (clk), .d (n_62), .sena (1'b1), .aclr (n_7),
       .apre (1'b0), .srl (1'b0), .srd (1'b0), .q (carry));
  ...
  not g7 (n_7, rst_n);
  CDN_flop \result_reg[0] (.clk (clk), .d (n_73), .sena (1'b1), .aclr
       (n_7), .apre (1'b0), .srl (1'b0), .srd (1'b0), .q (result[0]));
  CDN_flop \result_reg[1] (.clk (clk), .d (n_72), .sena (1'b1), .aclr
       (n_7), .apre (1'b0), .srl (1'b0), .srd (1'b0), .q (result[1]));
  CDN_flop \result_reg[2] (.clk (clk), .d (n_71), .sena (1'b1), .aclr
       (n_7), .apre (1'b0), .srl (1'b0), .srd (1'b0), .q (result[2]));
  CDN_flop \result_reg[3] (.clk (clk), .d (n_70), .sena (1'b1), .aclr
       (n_7), .apre (1'b0), .srl (1'b0), .srd (1'b0), .q (result[3]));
  CDN_mux7 mux_p_result_24_14_g5(.sel0 (n_109), .data0 (sum[3]), .sel1
       (n_112), .data1 (and_2[3]), .sel2 (n_115), .data2 (or_3[3]),
       .sel3 (n_118), .data3 (xor_4[3]), .sel4 (n_121), .data4
       (not_5[3]), .sel5 (n_124), .data5 (sright_6[3]), .sel6 (n_127),
       .data6 (sleft_7[3]), .z (n_70));
  CDN_mux7 mux_p_result_24_14_g13(.sel0 (n_109), .data0 (sum[2]), .sel1
       (n_112), .data1 (and_2[2]), .sel2 (n_115), .data2 (or_3[2]),
       .sel3 (n_118), .data3 (xor_4[2]), .sel4 (n_121), .data4
       (not_5[2]), .sel5 (n_124), .data5 (sright_6[2]), .sel6 (n_127),
       .data6 (sleft_7[2]), .z (n_71));
  CDN_mux7 mux_p_result_24_14_g14(.sel0 (n_109), .data0 (sum[1]), .sel1
       (n_112), .data1 (and_2[1]), .sel2 (n_115), .data2 (or_3[1]),
       .sel3 (n_118), .data3 (xor_4[1]), .sel4 (n_121), .data4
       (not_5[1]), .sel5 (n_124), .data5 (sright_6[1]), .sel6 (n_127),
       .data6 (sleft_7[1]), .z (n_72));
  CDN_mux7 mux_p_result_24_14_g15(.sel0 (n_109), .data0 (sum[0]), .sel1
       (n_112), .data1 (and_2[0]), .sel2 (n_115), .data2 (or_3[0]),
       .sel3 (n_118), .data3 (xor_4[0]), .sel4 (n_121), .data4
       (not_5[0]), .sel5 (n_124), .data5 (sright_6[0]), .sel6 (n_127),
       .data6 (sleft_7[0]), .z (n_73));
  nor g6 (n_109, op[1], op[2]);
  not g90 (n_136, op[2]);
  not g91 (n_137, op[1]);
  not g92 (n_138, op[0]);
  not g93 (n_139, b[3]);
  ...
  not g95 (n_141, b[1]);
  not g96 (n_142, b[0]);
  nor g97 (n_112, op[2], n_137, op[0]);
  nor g98 (and_2[3], not_5[3], n_139);
  nor g99 (n_115, op[2], n_137, n_138);
  nand g100 (or_3[3], not_5[3], n_139);
  nor g101 (n_118, n_136, op[1], op[0]);
  nor g102 (n_121, n_136, op[1], n_138);
  nor g103 (n_124, n_136, n_137, op[0]);
  nor g104 (n_127, n_136, n_137, n_138);
  nor g105 (and_2[2], not_5[2], n_140);
  nand g106 (or_3[2], not_5[2], n_140);
  nor g107 (and_2[1], not_5[1], n_141);
  nand g108 (or_3[1], not_5[1], n_141);
  nor g109 (and_2[0], not_5[0], n_142);
  nand g110 (or_3[0], not_5[0], n_142);
  and g111 (n_62, n_109, c);
endmodule
