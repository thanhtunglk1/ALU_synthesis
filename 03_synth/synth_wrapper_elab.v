...
// Generated on: May 20 2025 07:24:55
...
module bmux_7(ctl, in_0, in_1, in_2, in_3, in_4, in_5, in_6, in_7, z);
  input [2:0] ctl;
...
module alu(clk, rst_n, a, b, op, result, carry);
  ...
  bmux_6 mux_carry_40_13(.ctl (n_6), .in_0 (p_carry), .in_1 (1'b0), .z
       (UNCONNECTED));
  bmux_7 mux_p_result_24_14(.ctl (op), .in_0 (sum), .in_1 (sum), .in_2
       (and_2), .in_3 (or_3), .in_4 (xor_4), .in_5 (not_5), .in_6
       (sright_6), .in_7 (sleft_7), .z (p_result));
  bmux mux_result_40_13(.ctl (n_6), .in_0 (p_result), .in_1 (4'b0000),
       .z ({UNCONNECTED3, UNCONNECTED2, UNCONNECTED1, UNCONNECTED0}));
  or g6 (n_18, op[2], op[1]);
  not g7 (n_19, n_18);
  and g8 (p_carry, n_19, c);
  not g9 (n_6, rst_n);
  xor g1 (b_value[0], b[0], op[0]);
  xor g13 (b_value[1], b[1], op[0]);
  xor g14 (b_value[2], b[2], op[0]);
  xor g15 (b_value[3], b[3], op[0]);
  and g16 (and_2[0], a[0], b[0]);
  and g2 (and_2[1], a[1], b[1]);
  and g17 (and_2[2], a[2], b[2]);
  and g18 (and_2[3], a[3], b[3]);
  or g19 (or_3[0], a[0], b[0]);
  or g20 (or_3[1], a[1], b[1]);
  or g3 (or_3[2], a[2], b[2]);
  or g21 (or_3[3], a[3], b[3]);
...
module synth_wrapper(clk, rst_n, a, b, op, result, carry);
  ...
  bmux_9 mux_op_reg_17_10(.ctl (n_17), .in_0 (op), .in_1 (3'b000), .z
