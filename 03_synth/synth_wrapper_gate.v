...
// Generated on: May 17 2025 05:33:18
...
module alu(clk, rst_n, a, b, op, result, carry);
  ...
  sky130_fd_sc_hd__dfrtp_1 carry_reg(.RESET_B (rst_n), .CLK (clk), .D
       (n_301), .Q (carry));
  sky130_fd_sc_hd__nand2_1 g8769(.A (n_401), .B (n_139), .Y (n_157));
  ...
  sky130_fd_sc_hd__nand3_1 g8788(.A (n_127), .B (n_116), .C (n_125), .Y
       (n_140));
  sky130_fd_sc_hd__and4_1 g8789(.A (n_129), .B (n_320), .C (n_120), .D
       (n_403), .X (n_139));
  sky130_fd_sc_hd__nand2_2 g8792(.A (n_124), .B (n_62), .Y (n_136));
  sky130_fd_sc_hd__a21oi_2 g8793(.A1 (n_235), .A2 (n_8), .B1 (n_2), .Y
       (n_135));
  sky130_fd_sc_hd__nor2_1 g8801(.A (n_356), .B (n_235), .Y (n_130));
  sky130_fd_sc_hd__nand2_1 g8802(.A (n_274), .B (n_211), .Y (n_129));
  sky130_fd_sc_hd__o2bb2ai_1 g8804(.A1_N (n_82), .A2_N (n_277), .B1
       (n_24), .B2 (b[0]), .Y (n_127));
  sky130_fd_sc_hd__o221ai_1 g8806(.A1 (n_364), .A2 (n_76), .B1 (n_24),
  ...
  sky130_fd_sc_hd__a21oi_1 g8809(.A1 (n_65), .A2 (b[0]), .B1 (n_95), .Y
       (n_122));
  sky130_fd_sc_hd__nand2_1 g8811(.A (n_273), .B (n_376), .Y (n_120));
  sky130_fd_sc_hd__o21a_2 g8812(.A1 (n_227), .A2 (n_249), .B1 (n_189),
       .X (n_119));
  sky130_fd_sc_hd__a31oi_1 g8814(.A1 (n_57), .A2 (n_250), .A3 (n_24),
       .B1 (n_97), .Y (n_116));
  sky130_fd_sc_hd__o32a_1 g8818(.A1 (n_27), .A2 (n_12), .A3 (n_22), .B1
       (n_23), .B2 (n_317), .X (n_113));
  sky130_fd_sc_hd__o2bb2ai_2 g8827(.A1_N (n_376), .A2_N (n_371), .B1
       (n_376), .B2 (n_371), .Y (n_110));
  sky130_fd_sc_hd__o22ai_1 g8833(.A1 (n_24), .A2 (n_317), .B1 (n_27),
       .B2 (n_328), .Y (n_97));
  sky130_fd_sc_hd__nand2_2 g8834(.A (n_394), .B (n_46), .Y (n_104));
  sky130_fd_sc_hd__nand2_2 g8841(.A (n_279), .B (n_210), .Y (n_95));
  sky130_fd_sc_hd__or2_1 g8851(.A (n_16), .B (n_27), .X (n_79));
  sky130_fd_sc_hd__nand2_4 g8857(.A (n_224), .B (n_61), .Y (n_82));
  sky130_fd_sc_hd__a2bb2oi_1 g8865(.A1_N (n_24), .A2_N (n_12), .B1
       (b[0]), .B2 (n_41), .Y (n_67));
  sky130_fd_sc_hd__o2bb2ai_2 g8866(.A1_N (n_372), .A2_N (n_42), .B1
       (a[3]), .B2 (n_42), .Y (n_75));
  sky130_fd_sc_hd__inv_1 g8873(.A (n_328), .Y (n_62));
  sky130_fd_sc_hd__inv_2 g8875(.A (n_27), .Y (n_61));
  sky130_fd_sc_hd__clkinv_1 g8878(.A (n_249), .Y (n_57));
  sky130_fd_sc_hd__nand2_1 g8880(.A (n_43), .B (b[0]), .Y (n_56));
  sky130_fd_sc_hd__nor2_1 g8884(.A (n_285), .B (n_9), .Y (n_65));
  sky130_fd_sc_hd__nand2_2 g8887(.A (n_32), .B (op[1]), .Y (n_27));
  sky130_fd_sc_hd__nand2_1 g8896(.A (n_38), .B (b[1]), .Y (n_46));
  sky130_fd_sc_hd__and2_1 g8899(.A (b[0]), .B (n_372), .X (n_53));
  ...
  sky130_fd_sc_hd__inv_2 g8923(.A (n_258), .Y (n_19));
  sky130_fd_sc_hd__inv_2 g8926(.A (op[0]), .Y (n_36));
  sky130_fd_sc_hd__clkinv_1 g8933(.A (op[0]), .Y (n_18));
  sky130_fd_sc_hd__inv_2 g8934(.A (op[2]), .Y (n_32));
  sky130_fd_sc_hd__inv_1 g8937(.A (b[3]), .Y (n_16));
  sky130_fd_sc_hd__inv_2 g8950(.A (n_12), .Y (n_13));
  sky130_fd_sc_hd__inv_2 g8951(.A (b[1]), .Y (n_12));
  sky130_fd_sc_hd__clkbuf_1 g8953(.A (b[1]), .X (n_29));
  sky130_fd_sc_hd__inv_2 fopt8973(.A (n_352), .Y (n_8));
  sky130_fd_sc_hd__nand3_1 g3(.A (n_364), .B (n_208), .C (n_56), .Y
       (n_7));
  sky130_fd_sc_hd__nand2_1 g8975(.A (n_208), .B (n_56), .Y (n_5));
  sky130_fd_sc_hd__nor2b_1 g8980(.A (n_253), .B_N (n_345), .Y (n_2));
  sky130_fd_sc_hd__nand3_1 g8994(.A (n_42), .B (n_13), .C (n_285), .Y
       (n_189));
  sky130_fd_sc_hd__nand2b_1 g9010(.A_N (a[1]), .B (n_42), .Y (n_208));
  sky130_fd_sc_hd__inv_1 g9011(.A (a[1]), .Y (n_41));
  sky130_fd_sc_hd__and2b_4 g9012(.A_N (b[3]), .B (n_25), .X (n_210));
  sky130_fd_sc_hd__clkinv_1 g9013(.A (n_25), .Y (n_211));
  sky130_fd_sc_hd__inv_2 g9025(.A (n_18), .Y (n_224));
  sky130_fd_sc_hd__nand2_2 g9026(.A (n_29), .B (n_225), .Y (n_226));
  sky130_fd_sc_hd__inv_2 g9027(.A (op[0]), .Y (n_225));
  sky130_fd_sc_hd__inv_2 g9029(.A (op[0]), .Y (n_227));
  sky130_fd_sc_hd__inv_2 g9030(.A (n_225), .Y (n_229));
  sky130_fd_sc_hd__a21oi_1 g9047(.A1 (n_13), .A2 (n_253), .B1 (n_53),
       .Y (n_243));
  sky130_fd_sc_hd__nand2_4 g9051(.A (n_42), .B (n_12), .Y (n_249));
  sky130_fd_sc_hd__inv_2 g9052(.A (n_282), .Y (n_250));
  sky130_fd_sc_hd__nand4_2 g9054(.A (n_251), .B (n_252), .C (n_250), .D
       (n_255), .Y (n_256));
  sky130_fd_sc_hd__nand2_1 g9055(.A (n_5), .B (n_9), .Y (n_251));
  sky130_fd_sc_hd__nand2_1 g9056(.A (n_53), .B (n_364), .Y (n_252));
  sky130_fd_sc_hd__nand2_1 g9057(.A (n_253), .B (n_57), .Y (n_255));
  sky130_fd_sc_hd__inv_4 g9061(.A (n_36), .Y (n_258));
  sky130_fd_sc_hd__nor2_2 g9071(.A (op[1]), .B (n_32), .Y (n_269));
  sky130_fd_sc_hd__inv_2 g9072(.A (n_271), .Y (n_272));
  sky130_fd_sc_hd__nand2_4 g9073(.A (n_269), .B (n_270), .Y (n_271));
  sky130_fd_sc_hd__inv_2 g9074(.A (n_258), .Y (n_270));
  sky130_fd_sc_hd__o21ai_1 g9075(.A1 (n_211), .A2 (n_271), .B1 (n_82),
       .Y (n_273));
  sky130_fd_sc_hd__o221ai_2 g9076(.A1 (n_376), .A2 (n_271), .B1
       (n_372), .B2 (n_27), .C1 (n_82), .Y (n_274));
  sky130_fd_sc_hd__a21o_1 g9078(.A1 (n_276), .A2 (n_356), .B1 (n_62),
       .X (n_277));
  sky130_fd_sc_hd__buf_1 g9079(.A (n_271), .X (n_276));
  sky130_fd_sc_hd__nor2_4 g9080(.A (n_278), .B (n_229), .Y (n_279));
  sky130_fd_sc_hd__nand2_2 g9081(.A (op[2]), .B (op[1]), .Y (n_278));
  sky130_fd_sc_hd__nor2_1 g9082(.A (n_18), .B (n_278), .Y (n_281));
  sky130_fd_sc_hd__nand4b_1 g9084(.A_N (n_278), .B (n_258), .C (n_25),
       .D (n_16), .Y (n_282));
  sky130_fd_sc_hd__nand2_4 g9085(.A (n_226), .B (n_299), .Y (n_283));
  sky130_fd_sc_hd__buf_6 g9087(.A (a[1]), .X (n_285));
  sky130_fd_sc_hd__nand2_1 g9088(.A (n_339), .B (n_287), .Y (n_288));
  ...
  sky130_fd_sc_hd__nand2_1 g9092(.A (n_343), .B (n_344), .Y (n_345));
  sky130_fd_sc_hd__nand2_1 g9093(.A (n_227), .B (b[3]), .Y (n_343));
  ...
  sky130_fd_sc_hd__nand3_1 g9094(.A (n_350), .B (n_351), .C (a[2]), .Y
       (n_352));
  ...
  sky130_fd_sc_hd__inv_2 g9095(.A (n_9), .Y (n_364));
  sky130_fd_sc_hd__inv_2 g5(.A (n_393), .Y (n_9));
  sky130_fd_sc_hd__nand3_1 g9096(.A (n_368), .B (n_367), .C (n_369), .Y
       (n_370));
  sky130_fd_sc_hd__nand2_1 g9097(.A (n_396), .B (n_130), .Y (n_367));
  sky130_fd_sc_hd__a21oi_2 g9098(.A1 (n_361), .A2 (a[3]), .B1 (n_294),
       .Y (n_368));
  sky130_fd_sc_hd__a21o_1 g9099(.A1 (n_296), .A2 (n_110), .B1 (n_355),
       .X (n_369));
  ...
  sky130_fd_sc_hd__nand2_2 g9101(.A (n_384), .B (n_385), .Y (n_386));
  sky130_fd_sc_hd__nand2_2 g9102(.A (n_283), .B (n_41), .Y (n_384));
  sky130_fd_sc_hd__nand3_1 g9103(.A (n_226), .B (n_299), .C (n_285), .Y
       (n_385));
  sky130_fd_sc_hd__nand3b_1 g9104(.A_N (n_373), .B (n_386), .C (n_311),
       .Y (n_389));
  sky130_fd_sc_hd__nand4_1 g9105(.A (n_386), .B (n_235), .C (n_373), .D
       (n_338), .Y (n_390));
  sky130_fd_sc_hd__nand3_1 g9106(.A (n_341), .B (n_235), .C (n_386), .Y
       (n_391));
  sky130_fd_sc_hd__nand2_1 g9108(.A (n_393), .B (a[1]), .Y (n_394));
  ...
  sky130_fd_sc_hd__nand3_1 g9109(.A (n_398), .B (n_400), .C (n_311), .Y
       (n_401));
  sky130_fd_sc_hd__nand2_1 g9110(.A (n_397), .B (n_295), .Y (n_398));
  sky130_fd_sc_hd__inv_1 g33(.A (n_296), .Y (n_397));
  sky130_fd_sc_hd__nand2_1 g9111(.A (n_110), .B (n_296), .Y (n_400));
  sky130_fd_sc_hd__o2111ai_1 g9113(.A1 (n_376), .A2 (n_249), .B1
  ...
  sky130_fd_sc_hd__nand2b_1 g9114(.A_N (n_285), .B (n_57), .Y (n_405));
  sky130_fd_sc_hd__nand2b_1 g9115(.A_N (n_317), .B (n_253), .Y (n_406));
  sky130_fd_sc_hd__nand3b_1 g9116(.A_N (n_386), .B (n_373), .C (n_311),
       .Y (n_407));
endmodule
